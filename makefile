...
DriverAvailableListener.o: src/listeners/DriverAvailableListener.cpp src/listeners/DriverAvailableListener.h
	g++ -std=c++0x -c src/listeners/DriverAvailableListener.cpp
